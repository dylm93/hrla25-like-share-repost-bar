        ...
        return (
            <div>
                ...
                <div className= 'counts'>
                    <span className = 'plays' style ={{color: '#8c8c8c'}}><img src='http://measuremenow.com/assets/images/play_button_grey.png' width="10" height="13"/> {this.state.playsCount}</span>
